...
public class WalletController {
    ...
    public WalletController(WalletService walletService, OutboxProcessor outboxProcessor) {
    ...
    private boolean isValidSortField(String sortBy) {
        return sortBy != null && (sortBy.equals("timestamp") ||
    ...
    public ResponseEntity<Void> withdraw(@Valid @RequestBody WithdrawRequest request) {
        boolean ok = walletService.withdraw(request);
    ...
    public ResponseEntity<Page<HistoryResponse>> getHistory(
            ...
            @Parameter(description = "Сортировка (timestamp, amount, description)", example = "timestamp")
    ...
    public ResponseEntity<Void> adminDeposit(
            ...
            @Valid @RequestBody DepositRequest request) {
        walletService.adminDeposit(userId, request);
        return ResponseEntity.ok().build();
    }
